...
// Proton VPN does not expose activatable NetworkManager profiles, so every
// action goes through the `protonvpn` CLI in VpnController, which also keeps the
// state cached while this panel is unloaded.
PanelWindow {
    id: vpnWindow
    ...
    Item {
        ...
        height: opened ? Math.min(locationSelection ? 520 : 366, parent.height - 46) : 0
        clip: true
        opacity: opened ? 1 : 0
                    ...
                    Column {
                        ...
                        Rectangle {
                            ...
                            TextInput {
                                ...
                                font.pixelSize: 12
                                onTextChanged: vpnWindow.countryFilter = text
                                ...
                                Repeater {
                                    ...
                                    Rectangle {
                                        ...
                                        MouseArea {
                                            ...
                                            anchors.fill: parent
                                            hoverEnabled: true
                                            enabled: !vpnWindow.busy
                                            cursorShape: Qt.PointingHandCursor
                                            onClicked: vpnWindow.controller.connectCountry(modelData.code)
                                        }
